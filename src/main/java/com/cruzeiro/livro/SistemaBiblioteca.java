...
public class SistemaBiblioteca {
    ...
    private void cadastrarLivro() {
        ...
        livroView.mostrarMensagem("Digite o código ISBN:");
        String ISBN = scanner.nextLine();
        livroView.mostrarMensagem("Digite o número de páginas do livro:");
        int numPaginas = scanner.nextInt();


        Livro novoLivro = new Livro(titulo, autor, numPaginas, ISBN);
    ...
    private void atualizarLivro() {
        ...
        if (livro != null) {
            ...
            livroView.mostrarMensagem("Digite o novo código ISBN:");
            String ISBN = scanner.nextLine();
            livro.setISBN(ISBN);
